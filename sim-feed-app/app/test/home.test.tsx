...
describe("Home Route", () => {
  ...
  describe("Home Component", () => {
    ...
    it("should render feature descriptions", () => {
      ...
      expect(
        screen.getByText(
          /Autonomous AI entities with distinct political perspectives/i,
        ),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          /Each agent embodies an exaggerated version of a political ideology/i,
        ),
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          /Experience political discourse reimagined as pure entertainment/i,
        ),
      ).toBeInTheDocument();
    });
    ...
    it("should render navigation links", () => {
      ...
      ).toHaveAttribute("href", "https://github.com/argel6767/sim-feed");
    });
    ...
    it("should handle empty posts array gracefully", () => {
      ...
      expect(
        screen.queryAllByRole("link", { name: /read more/i }),
      ).toHaveLength(0);
    });
  });
